...
class Client {
  ...
  parseOptions (options) {
    const apiKey = options.apiKey || process.env['__OW_API_KEY']
    const ignoreCerts = options.ignoreCerts || false
    ...
    const apigwToken = options.apigwToken || process.env['__OW_APIGW_TOKEN']
    let apigwSpaceGuid = options.apigwSpaceGuid || process.env['__OW_APIGW_SPACE_GUID']
